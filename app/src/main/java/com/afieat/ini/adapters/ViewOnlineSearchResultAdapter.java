...
public class ViewOnlineSearchResultAdapter extends RecyclerView.Adapter<ViewOnlineSearchResultAdapter.ViewHolder> implements Filterable {
    ...
    public ViewOnlineSearchResultAdapter(Context mContext,
...
/*
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        try {
            ...
            setPricingVariant(search.mPriceList, search.mActualPriceList, search.getFoodName(), search.getPriceLitingSize());
...
//-------------------------------------------------------------------------------------------------------------------
            ...
            if (AppUtils.IS_SUPER_MARKET) {
                ...
                if (AppUtils.testHashMap.size() > 0 && AppUtils.testHashMap.get(search.getFood_id()) != null) {
...
//            view.findViewById(R.id.share_linear).setVisibility(View.VISIBLE);
    ...
    public void setPricingVariant(List<DemoSearchModel.Price> mPriceList, List<DemoSearchModel.ActualPrice> mActualPriceList, String foodName, int priceListingSize) {
        llPrices = view.findViewById(R.id.llPrices);
        Gson uu = new Gson();
        // System.out.println("Rahul :  : "+foodName+"---"+uu.toJson(mPriceList));
        for (int i = 0; i < priceListingSize; i++) {

            System.out.println("for loop for setPricingVariant with size " + foodName + "/" + priceListingSize + "---" + uu.toJson(mPriceList));
