...
public class SearchSelectSizeDialogAdapter extends RecyclerView.Adapter<SearchSelectSizeDialogAdapter.MyViewHolder> {
    ...
    public SearchSelectSizeDialogAdapter(Context c, JSONArray mJsonArray_actual_price, JSONArray mJsonArray_sales_price) {
        this.c = c;
...
*/
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvPrice, tvPlate, tvActualPrice;
